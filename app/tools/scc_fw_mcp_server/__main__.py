"""
Command-line interface for the FW MCP Server.
"""
import argparse
import asyncio
import os

from .server import FWMCPServer
...
def parse_args():
    ...
    Returns:
        Parsed arguments
    """
    parser = argparse.ArgumentParser(description="Cisco SCC FW MCP Server")
...
async def run_server(args):
    """
    Run the SCC FW MCP Server with the specified arguments.
